...
[![skills.sh](https://skills.sh/b/PhantomCodeGhost/skill-updater)](https://skills.sh/PhantomCodeGhost/skill-updater)
...
npx skills add PhantomCodeGhost/skill-updater -g -a claude-code
npx skills add PhantomCodeGhost/skill-updater -g -a gemini-cli
```
